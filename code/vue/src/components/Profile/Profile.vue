...
<template>
  <div v-if="authStore.user" class="max-w-3xl mx-auto p-8 bg-white rounded-lg shadow-lg space-y-8">
    ...
    <div
      class="space-y-6 md:space-y-0 md:flex md:justify-between items-center md:items-start bg-white shadow-lg rounded-lg p-6"
    >
      ...
      <div class="flex items-center space-x-6">
        ...
        <div>
          ...
          <p class="text-sm text-gray-600">
            ...
            {{ authStore.user.type == 'P' ? 'Player' : 'Admin' }}
          </p>
    ...
    <div class="flex justify-center md:justify-start gap-4 mt-6">
      ...
      <button
        v-if="!showProfileForm && !formDelete"
      ...
      <button
        v-if="!formDelete && !showProfileForm && authStore.userType == 'P'"
      ...
      <div v-if="formDelete" class="mt-6">
        <ProfileDelete @hidedeleteForm="hidedeleteForm" />
        <!-- Profile Form Component -->
      </div>
      <button
        v-if="!formDelete && !showProfileForm && authStore.userType == 'A'"
    ...
    <div v-if="showProfileForm" class="mt-6">
      <ProfileForm @back-to-profile="backToProfile" />
      <!-- Profile Form Component -->
    </div>
  </div>
