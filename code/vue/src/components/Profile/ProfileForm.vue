        ...
        <div v-if="authStore.user" class="space-y-4">
            ...
            <div class="mt-4">
                <button @click="updateProfile"
                    class="w-full py-2 bg-blue-500 text-white rounded-md hover:bg-blue-600">Update Profile</button>
            </div>

            <div class="mt-4">
                <button @click="backToProfile"
                    class="w-full py-2 bg-white-500 text-black rounded-md hover:bg-white-600">Back</button>
            </div>
        </div>
    </div>
</template>
