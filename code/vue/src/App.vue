  ...
  <div class="p-4 sm:p-8 mx-auto max-w-full lg:max-w-7xl min-h-screen space-y-6">
    ...
    <header
      ...
      <p class="text-sm sm:text-lg text-center sm:text-right">
        <span v-if="storeAuth.user">
          ...
          <img v-if="storeAuth.userPhotoUrl" :src="storeAuth.userPhotoUrl" alt="User Photo"
    ...
    <nav
      ...
      <div class="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
        <RouterLink v-if="!isAdmin" :to="{ name: 'singlePlayerGames' }"
        ...
        <RouterLink v-if="!isAdmin" :to="{ name: 'multiPlayerGames' }"
        ...
        <RouterLink v-if="authenticated" :to="{ name: 'history' }"
        ...
        <div class="relative">
          ...
          <div v-if="isDropdownOpen"
            ...
            <div class="py-1">
              <router-link v-if="authenticated && !isAdmin" :to="{ name: 'scoreboardPersonal' }"
        ...
        <RouterLink v-if="authenticated" :to="{ name: 'transactions' }"
      ...
      <div class="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
        <RouterLink v-show="!authenticated" :to="{ name: 'login' }"
